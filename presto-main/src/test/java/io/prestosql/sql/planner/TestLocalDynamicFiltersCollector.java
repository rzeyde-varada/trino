...
public class TestLocalDynamicFiltersCollector
{
    ...
    public void testSingle()
    {
        ...
        collector.collectDynamicTupleDomain(ImmutableMap.of(filterId, domain));
    ...
    public void testMultipleBuildColumnsSingleProbeColumn()
    {
        ...
        collector.collectDynamicTupleDomain(
    ...
    public void testUnusedDynamicFilter()
    {
        ...
        collector.collectDynamicTupleDomain(ImmutableMap.of(unusedFilterId, Domain.singleValue(BIGINT, 1L)));
        ...
        collector.collectDynamicTupleDomain(ImmutableMap.of(usedFilterId, Domain.singleValue(BIGINT, 2L)));
    ...
    public void testUnregisteredDynamicFilter()
    {
        ...
        collector.collectDynamicTupleDomain(ImmutableMap.of(registeredFilterId, Domain.singleValue(BIGINT, 2L)));
